...
mcmcplot2(gamma_samples_inf$beta)
...
show_replicate_analysis(all_storms, rlnorm, lognorm_samples_noninf$mu, sqrt(lognorm_samples_noninf$sig2)) # remember sqrt!
show_replicate_analysis(all_storms, rgamma, gamma_samples_noninf$alpha, gamma_samples_noninf$beta)
